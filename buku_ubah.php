                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <select name="id_kategori" class="form-control">
                                ...
                                ?>
                                <option <?php if($data['id_kategori'] == $kategori_buku['id_kategori']) echo 'selected'; ?> value="<?php echo $kategori_buku['id_kategori']; ?>"><?php echo $kategori_buku['nama_kategori']; ?></option>
                                    <?php
                                    }
                                    ?>
                            </select>
